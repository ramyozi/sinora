  ...
  return (
    <>
      ...
      <dialog
        ...
        className="fixed inset-auto right-0 top-0 m-0 h-dvh max-h-dvh w-80 max-w-[88vw] overflow-y-auto bg-background p-6 text-foreground shadow-2xl backdrop:bg-foreground/40 [padding-top:max(1.5rem,env(safe-area-inset-top))] [padding-right:max(1.5rem,env(safe-area-inset-right))] [padding-bottom:max(1.5rem,env(safe-area-inset-bottom))]"
      >
